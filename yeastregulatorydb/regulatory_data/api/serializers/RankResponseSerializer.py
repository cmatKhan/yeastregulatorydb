...
class RankResponseSerializer(CustomValidateMixin, serializers.ModelSerializer):
    ...
    single_binding = serializers.IntegerField(read_only=True)
    composite_binding = serializers.IntegerField(read_only=True)
    ...
    binding_source = serializers.SerializerMethodField(read_only=True)
    expression_source = serializers.SerializerMethodField(read_only=True)
    ...
    perturbation_rank_threshold = serializers.SerializerMethodField(read_only=True)
    binding_set_size = serializers.SerializerMethodField(read_only=True)
    perturbation_set_size = serializers.SerializerMethodField(read_only=True)
    dto_fdr = serializers.SerializerMethodField(read_only=True)
    dto_empirical_pvalue = serializers.SerializerMethodField()
    genomic_inserts = serializers.IntegerField(read_only=True)
    mito_inserts = serializers.IntegerField(read_only=True)
    plasmid_inserts = serializers.IntegerField(read_only=True)
    ...
    def get_dto_fdr(self, obj):
        return self._safe_get(obj.dto_result, ["fdr"])

    def get_dto_empirical_pvalue(self, obj):
