"""
.. module:: CallingCardsBackground
   :synopsis: A clone of the binding model which stores the background data
   used to calculate the Calling Cards enrichment score and p-values

This model is used to keep an index of the files which store callingcards
background data.
...
class CallingCardsBackground(BaseModel, FileUploadMixin):
    ...
    def save(self, *args, **kwargs):
        ...
        self.update_file_name("file", f"callingcards/background", "tsv.gz")
